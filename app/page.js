...
export const metadata = {
  ...
  description:
    "Перевірені майстри у Камʼянському: електрик, сантехнік, ремонт квартир. Залиште заявку — підберемо спеціаліста сьогодні. Без прихованих комісій.",
    ...
    images: [
      {
        ...
        width: 1536,
        height: 1024,
        alt: "Перевірені майстри у Камʼянському — електрик, сантехнік, ремонт квартир",
      },
    ],
  },
