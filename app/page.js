...
export const metadata = {
  title: "Майстри у Дніпрі та Камʼянському — електрик, сантехнік, ремонт | Очерет",
  description:
    "Перевірені майстри у Дніпрі та Камʼянському: електрик, сантехнік, ремонт квартир. Залиште заявку — підберемо спеціаліста сьогодні. Без прихованих комісій.",
  ...
  openGraph: {
    title: "Майстри у Дніпрі та Камʼянському — сервіс підбору майстрів",
    description:
      "Перевірені майстри у Дніпрі та Камʼянському: електрик, сантехнік, ремонт квартир. Залиште заявку — підберемо спеціаліста сьогодні. Без прихованих комісій.",
    ...
    images: [
      {
        ...
        width: 1536,
        height: 1024,
        alt: "Перевірені майстри у Дніпрі та Камʼянському — електрик, сантехнік, ремонт квартир",
      },
    ],
  },
  ...
  twitter: {
    ...
    title: "Майстри у Дніпрі та Камʼянському — Очерет",
    description:
      "Сервіс підбору перевірених майстрів у Дніпрі та Камʼянському. Електрик, сантехнік, ремонт квартир.",
...
export default function Home() {
  ...
  {
    q: "У яких містах працює сервіс «Очерет»?",
    a: "Наразі сервіс працює у Дніпрі та Кам'янському. Ми підбираємо майстрів у вашому місті та районі для швидкого виїзду на об'єкт.",
  },
  {
    q: "Чи можна замовити майстра терміново?",
    a: "Так, можливий терміновий виїзд майстра. Залиште заявку на сайті — ми підберемо доступного спеціаліста у вашому місті якнайшвидше.",
  },
  {
    q: "Як швидко майстер приїде після заявки?",
    a: "Час виїзду залежить від міста, району та завантаженості майстрів. У більшості випадків майстер зв'язується з вами протягом короткого часу після підтвердження заявки.",
  },
  {
    q: "Чи надається гарантія на виконані роботи?",
    a: "Так, майстри надають гарантію на виконані роботи за умови дотримання рекомендацій з експлуатації. Умови гарантії уточнюються з майстром до початку робіт.",
  },
  {
    q: "Які послуги доступні через сервіс?",
    a: "Через «Очерет» можна замовити електрика, сантехніка, майстра з ремонту техніки та інших спеціалістів для дому та бізнесу у Дніпрі та Кам'янському.",
  },
  {
    q: "Чи працюють майстри у вихідні та святкові дні?",
    a: "Так, частина майстрів доступна у вихідні та святкові дні. Наявність уточнюється при оформленні заявки.",
  },
  {
    q: "Як залишити відгук про майстра?",
    a: "Після виконання робіт ви можете залишити відгук про майстра на Google. Відгуки допомагають іншим клієнтам обирати перевірених спеціалістів.",
  },
];
  const schema = {
    ...
    <>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 xl:px-24">
          <h2 className="text-3xl font-bold mb-10 text-center">
            Популярні послуги майстрів у Дніпрі та Камʼянському
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              },
              {
                ...
                text: "Підбираємо перевіреного спеціаліста у Дніпрі та Камʼянському відповідно до вашого запиту",
              },
              {
                step: "03",
      ...
      <section className="pt-20 relative pb-96 xl:pb-[500px]">
        ...
        <div className="container relative mx-auto px-4 xl:px-24">
          <h2 className="text-3xl font-bold mb-6">
            Перевірені майстри у Дніпрі та Камʼянському
          </h2>

          <div className="space-y-4 leading-relaxed">
            <p>
              Сервіс <strong>«Очерет»</strong> допомагає швидко знайти
              перевіреного майстра у Дніпрі та Камʼянському для виконання будь-яких
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link href="/dnipro/electryk" className="text-green-700 hover:underline">
              Електрик у Дніпрі
            </Link>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-3xl font-bold mb-10 text-center">
            Часті запитання про майстрів у Дніпрі та Камʼянському
          </h2>
