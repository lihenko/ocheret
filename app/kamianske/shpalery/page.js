  ...
  return (
    <>
      ...
      <section className="pb-20">
        <div className="container relative mx-auto px-4 xl:px-24">
          <h2 className="text-2xl font-semibold mb-4">
            Коли варто замовити поклейку шпалер у Кам’янському
          </h2>
          <p className="text-gray-700 mb-4">
            Поклейка шпалер стане актуальною у таких випадках:
          </p>
          <ul className="marked-list">
            <li className="text-gray-700">ви плануєте оновити інтер’єр квартири або будинку;</li>

            <li className="text-gray-700">старі шпалери втратили вигляд або почали відклеюватися;</li>

            <li className="text-gray-700">після ремонту необхідно акуратно оформити стіни;</li>

            <li className="text-gray-700">потрібно приховати нерівності або дефекти поверхні;</li>

            <li className="text-gray-700">хочете отримати рівні стики та професійний результат без зайвих зусиль.</li>
          </ul>
          <p className="text-gray-700">
            Якісна поклейка шпалер дозволяє створити акуратний вигляд приміщення та забезпечує довговічність покриття при дотриманні технології робіт.
          </p>
        </div>
      </section>
      ...
      <section className="pb-20">
        <div className="container relative mx-auto px-4 xl:px-24">
          <h2 className="text-2xl font-semibold mb-4">
            Поклейка шпалер у старих будинках Кам’янського
          </h2>
          <p className="text-gray-700 mb-4">
            У багатьох старих будинках Кам’янського стіни мають нерівності, тріщини або залишки старих покриттів. Це ускладнює якісну поклейку шпалер і впливає на кінцевий результат.
          </p>
          <p className="text-gray-700 mb-4">
            Професійний майстер:
          </p>
          <ul className="marked-list">
            <li className="text-gray-700">оцінює стан стін та їх підготовку;</li>

            <li className="text-gray-700">виявляє проблемні ділянки поверхні;</li>

            <li className="text-gray-700">виконує підготовку стін (шпаклівка, ґрунтування);</li>

            <li className="text-gray-700">акуратно клеїть шпалери з ідеальними стиками.</li>
          </ul>
          <p className="text-gray-700">
            Якісна підготовка та професійна поклейка забезпечують довговічність покриття та бездоганний вигляд стін у квартирі або будинку.
          </p>
        </div>
      </section>
      ...
      <section className="pb-20">
        <div className="container relative mx-auto px-4 xl:px-24">
          <h2 className="text-2xl font-semibold mb-4">
            Орієнтовна вартість поклейки шпалер у Кам’янському
          </h2>

          <p className="text-gray-700 mb-4">
            Ціни на поклейку шпалер залежать від типу шпалер, площі, складності підготовки стін та інших робіт. Нижче наведено середні орієнтовні розцінки станом на 2026 рік:
          </p>

          <ul className="marked-list text-gray-700">
            <li>Поклейка шпалер на стіни — від ~105 до ~200 грн/м² (середня ~144 грн/м²);</li>

            <li>Поклейка шпалер на стелю — від ~130 до ~250 грн/м² (середня ~160 грн/м²);</li>

            <li>Поклейка фотошпалер — від ~240 до ~400+ грн/м² (середня ~310 грн/м²);</li>

            <li>Додаткові роботи (підготовка стін, грунтовка, видалення старих шпалер) — від ~15–50 грн/м² залежно від обсягу.</li>
          </ul>

          <p className="text-gray-700">
            Точну ціну майстер назве після огляду приміщення. Вона може бути нижчою або вищою в залежності від стану стін, необхідності вирівнювання, підбору малюнка та складності робіт.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 xl:px-24">
          <div className="flex flex-wrap -mx-3 items-center">
            ...
            <div className="w-full px-3 md:w-1/2 mb-10 md:mb-0">
              <h2 className="text-2xl font-semibold mb-4">
                Чому обирають поклейку шпалер у Кам’янському
              </h2>
              <p className="text-gray-700 mb-4">
                Поклейка шпалер виконується з дотриманням технології та використанням якісних матеріалів. Майстри мають досвід роботи з різними видами шпалер — від паперових до флізелінових та вінілових.
              </p>
              <p className="text-gray-700 mb-16">
                Гарантується акуратність, рівні стики, чистота під час роботи та індивідуальний підхід до кожного об’єкта. Ви отримуєте ідеальний результат без зайвих витрат часу та нервів.
              </p>

              <h2 className="text-2xl font-semibold mb-4">
                Підготовка стін та поклейка шпалер
              </h2>
              <p className="text-gray-700 mb-4">
                Якісна поклейка шпалер починається з правильної підготовки поверхні: вирівнювання, шпаклювання та ґрунтування стін. Це дозволяє досягти ідеального результату без дефектів.
              </p>
              <p className="text-gray-700 mb-16">
                Майстер підбирає правильний клей, враховує тип шпалер та особливості приміщення, що гарантує довговічність покриття та відсутність відклеювання.
              </p>

              <h2 className="text-2xl font-semibold mb-4">
                Поклейка шпалер будь-якої складності
              </h2>
              <p className="text-gray-700">
                Професійний майстер:
              </p>
              <ul className="marked-list">
                <li className="text-gray-700">працює з різними видами шпалер (паперові, флізелінові, вінілові, фотошпалери);</li>

                <li className="text-gray-700">акуратно стикує малюнок;</li>

                <li className="text-gray-700">дотримується технології поклейки;</li>

                <li className="text-gray-700">забезпечує чистий та акуратний результат.</li>
              </ul>
              <p className="text-gray-700">
                Це дозволяє створити стильний інтер’єр та отримати ідеально рівні стіни без дефектів.
              </p>
            </div>

            <div className="w-full px-3 md:w-1/2">
              <Image 
                src="/pokleyka-shpaler-kamianske.webp" 
                width="1024" 
                height="1024" 
                alt="Поклейка шпалер Кам'янське"
              />
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 xl:px-24">
          <div className="flex flex-wrap -mx-3">
            ...
            <div className="w-full px-3 md:w-1/2 mb-10 md:mb-0">
              <h2 className="text-2xl font-semibold mb-4">
                Як проходить поклейка шпалер у Кам’янському
              </h2>
              <ol className="numbered-list text-gray-700">
                <li>Ви залишаєте заявку або зв’язуєтесь з майстром.</li>
                <li>Фахівець уточнює деталі та об’єм робіт.</li>
                <li>Проводиться оцінка стін та підготовка поверхні.</li>
                <li>Майстер виконує поклейку шпалер згідно технології.</li>
                <li>Ви отримуєте акуратний результат та рекомендації по догляду.</li>
              </ol>
            </div>

            <div className="w-full px-3 md:w-1/2">
              <h2 className="text-2xl font-semibold mb-4">
                Переваги поклейки шпалер у Кам’янському
              </h2>
              <p className="text-gray-700">
                Замовляючи послугу у професіонала, ви отримуєте:
              </p>
              <ul className="marked-list text-gray-700">
                <li>рівні стики та акуратне нанесення;</li>
                <li>правильну підготовку стін;</li>
                <li>якісні матеріали та інструменти;</li>
                <li>чистоту під час виконання робіт;</li>
                <li>довговічний та естетичний результат.</li>
              </ul>
              <p className="text-gray-700">
                Майстер працює безпосередньо на об’єкті, забезпечуючи якість та дотримання всіх технологічних норм.
              </p>
            </div>
