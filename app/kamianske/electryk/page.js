      ...
      <section className="py-20">
        <div className="container relative mx-auto px-4 xl:px-24">
          ...
          <p className="text-gray-700 mb-4">
            Послуги електрика необхідні у випадках монтажу або заміни електропроводки, встановлення розеток і вимикачів, <Link href={'/kamianske/electryk/vstanovlennia-avtomativ-i-schytkiv'}>встановлення автоматів і щитків</Link>, підключення освітлення, модернізації електромережі чи усунення аварійних ситуацій.
          </p>
