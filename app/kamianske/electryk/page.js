    ...
    <>
      ...
      <section className="py-20">
        <div className="container relative mx-auto px-4 xl:px-24">
          ...
          <p className="text-gray-700 mb-4">
            Послуги електрика необхідні у випадках монтажу або заміни електропроводки, <Link href={'/kamianske/electryk/vstanovlennya-rozetok-i-vymikachiv'}>встановлення розеток і вимикачів</Link>, <Link href={'/kamianske/electryk/vstanovlennia-avtomativ-i-schytkiv'}>встановлення автоматів і щитків</Link>, <Link href={'/kamianske/electryk/montazh-osvitlennya'}>підключення освітлення</Link>, модернізації електромережі чи усунення аварійних ситуацій.
          </p>
      ...
      <section className="pb-20">
        <div className="container relative mx-auto px-4 xl:px-24">
          ...
          <p className="text-gray-700 mb-4">
            Послуги електрика у Кам’янському актуальні як для планових робіт, так і для аварійних ситуацій. У квартирах найчастіше виникає потреба у заміні старої електропроводки, встановленні додаткових розеток, <Link href={'/kamianske/electryk/pidklyuchennya-pobutovoyi-tekhniky'}>підключенні побутової техніки</Link> або модернізації освітлення. У приватних будинках електрик виконує монтаж внутрішніх і зовнішніх електромереж, підключення електрокотлів, насосів, стабілізаторів напруги та генераторів.
          </p>
          <p className="text-gray-700">
