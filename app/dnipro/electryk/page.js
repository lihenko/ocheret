...
export const metadata = {
  title: "Електрик Дніпро — професійні електромонтажні роботи",
  description: "Послуги електрика у Дніпрі: електропроводка, розетки, освітлення, щитки, аварійні роботи. Виклик професійного електрика на місці.",
  keywords: [
    "електрик Дніпро",
    "електромонтаж Дніпро",
    "виклик електрика",
    "електропроводка Дніпро",
  ...
  publisher: "Ocheret",
  alternates: {
    canonical: "https://ocheret.dp.ua/dnipro/electryk",
  },
  openGraph: {
    title: "Електрик Дніпро — професійні електромонтажні роботи",
    description: "Послуги електрика у Дніпрі: електропроводка, розетки, освітлення, щитки, аварійні роботи. Виклик професійного електрика на місці.",
    siteName: "Очерет — майстри на всі руки",
    url: "https://ocheret.dp.ua/dnipro/electryk",
    type: "website",
    images: [
      { url: "https://ocheret.dp.ua/electryk-dnipro-img.webp", width: 1536, height: 1024, alt: "Електрик монтує ПЗВ" }
    ],
  },
  twitter: {
    ...
    title: "Електрик Дніпро — професійні електромонтажні роботи",
    description: "Послуги електрика у Дніпрі: електропроводка, розетки, освітлення, щитки, аварійні роботи. Виклик професійного електрика на місці.",
    images: ["https://ocheret.dp.ua/electryk-dnipro-img.webp"],
  },
};

export default function ElectrikDniproPage() {
  const faqs = [
  {
    q: "Чи можна викликати електрика терміново у Дніпрі?",
    a: "Так, можливий терміновий виїзд електрика у Дніпрі при аварійних ситуаціях, таких як відсутність світла, коротке замикання або спрацювання автоматики."
  },
  {
    q: "Скільки часу займає виїзд електрика по Дніпру?",
  ...
  },
  {
    ...
    a: "Так, на всі електромонтажні роботи у Дніпрі надається гарантія за умови дотримання рекомендацій з експлуатації."
  },
  {
    q: "Чи працює електрик з квартирами, будинками та бізнесом?",
    a: "Електрик виконує роботи у квартирах, приватних будинках, офісах, магазинах та інших комерційних приміщеннях у Дніпрі."
  },
  {
  ...
  {
    q: "Від чого залежить вартість послуг електрика у Дніпрі?",
...
const schema = {
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://ocheret.dp.ua/dnipro/electryk#service",
      "name": "Послуги електрика у Дніпрі",
      "description":
        "Професійні електромонтажні роботи для дому та бізнесу у Дніпрі: електропроводка, розетки, освітлення, електрощити, аварійні роботи.",
      "provider": {
        "@type": "LocalBusiness",
        "name": "Ocheret",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://ocheret.dp.ua/dnipro/electryk#faq",
    ...
    <>
      ...
      <section id="page-hero" className="relative flex items-center py-24 xl:py-36">
        <div className="absolute inset-0 -z-10">
          <Image
            src="/electryk-dnipro-img.webp"
            alt="Послуги електрика у Дніпрі"
            fill
        ...
        <div className="container mx-auto px-4 xl:px-24">
          <div className="max-w-3xl relative">
            <h1 className="text-3xl md:text-5xl font-extrabold leading-tight text-white">
              Електрик у Дніпрі — електромонтажні роботи, ремонт електрики
            </h1>
            <p className="mt-6 text-base md:text-lg text-white">
              Професійні електромонтажні роботи для квартир, будинків, офісів та комерційних приміщень у Дніпрі. Надійно, безпечно та з дотриманням усіх норм.
            </p>
      ...
      <section className="py-20">
        <div className="container relative mx-auto px-4 xl:px-24">
          <h2 className="text-2xl font-semibold mb-4"> Коли потрібні послуги електрика у Дніпрі </h2>
          <p className="text-gray-700 mb-4">
            Послуги електрика необхідні у випадках монтажу або заміни електропроводки, встановлення розеток і вимикачів, встановлення автоматів і щитків, підключення освітлення, модернізації електромережі чи усунення аварійних ситуацій.
          </p>
      ...
      <section className="pb-20">
        <div className="container relative mx-auto px-4 xl:px-24">
          <h2 className="text-2xl font-semibold mb-4">Електрик у Дніпрі для квартир, будинків і бізнесу</h2>
          <p className="text-gray-700 mb-4">
            Послуги електрика у Дніпрі актуальні як для планових робіт, так і для аварійних ситуацій. У квартирах найчастіше виникає потреба у заміні старої електропроводки, встановленні додаткових розеток, підключенні побутової техніки або модернізації освітлення. У приватних будинках електрик виконує монтаж внутрішніх і зовнішніх електромереж, підключення електрокотлів, насосів, стабілізаторів напруги та генераторів.
          </p>
          <p className="text-gray-700">
            Для комерційних об'єктів — магазинів, офісів, кафе — важливо забезпечити стабільну та безпечну роботу електромережі з урахуванням навантажень. Електрик у Дніпрі проводить розрахунок потужності, встановлює автомати захисту, ПЗВ (УЗО) та виконує підключення обладнання відповідно до норм безпеки.
          </p>
        </div>
      </section>
      ...
      <section className="pb-20">
        <div className="container relative mx-auto px-4 xl:px-24">
          <h2 className="text-2xl font-semibold mb-6"> Роботи, які виконує електрик у Дніпрі </h2>
      ...
      <section className="pb-20">
        <div className="container relative mx-auto px-4 xl:px-24">
          <h2 className="text-2xl font-semibold mb-4">Коли терміново потрібен електрик у Дніпрі</h2>
          <p className="text-gray-700 mb-4">
      ...
      <section className="pb-20">
        <div className="container relative mx-auto px-4 xl:px-24">
          <h2 className="text-2xl font-semibold mb-4">Електропроводка у старих будинках Дніпра</h2>
          <p className="text-gray-700 mb-4">
            У багатьох будинках Дніпра досі використовується стара алюмінієва проводка, яка не розрахована на сучасні навантаження. Велика кількість побутової техніки, бойлери, кондиціонери та електроплити створюють ризик перегріву проводів і коротких замикань.
          </p>
          <p className="text-gray-700 mb-4">
      ...
      <section className="pb-20">
        <div className="container relative mx-auto px-4 xl:px-24">
          <h2 className="text-2xl font-semibold mb-4"> Вартість послуг електрика у Дніпрі </h2>
        ...
        <div className="container mx-auto px-4 xl:px-24">
          <div className="flex flex-wrap -mx-3 items-center">
            <div className="w-full px-3 md:w-1/2 mb-10 md:mb-0">
              <h2 className="text-2xl font-semibold mb-4">Чому обирають послуги електрика у Дніпрі</h2>
              <p className="text-gray-700 mb-4">
                Електрики у Дніпрі мають багаторічний досвід роботи. Виконуються всі види електромонтажних робіт із дотриманням сучасних стандартів безпеки. Майстри оснащені професійним інструментом і використовують лише якісні матеріали.
              </p>
              ...
              <p className="text-gray-700 mb-4">
                Електрик у Дніпрі виконує встановлення розеток і вимикачів у зручних та безпечних місцях з урахуванням навантаження та призначення приміщення. Проводиться монтаж люстр, точкових світильників, LED-стрічок, підсвітки кухні та санвузла.
              </p>
              <p className="text-gray-700 mb-16">
            ...
            <div className="w-full px-3 md:w-1/2">
              <Image src="/electryk-dnipro.webp" width="1024" height="1024" alt="Електрик Дніпро"></Image>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 xl:px-24">
          <div className="flex flex-wrap -mx-3">
            <div className="w-full px-3 md:w-1/2 mb-10 md:mb-0">
              <h2 className="text-2xl font-semibold mb-4">Як працює підбір електрика у Дніпрі</h2>
            ...
            <div className="w-full px-3 md:w-1/2">
              <h2 className="text-2xl font-semibold mb-4">Переваги виклику електрика у Дніпрі</h2>
                <p className="text-gray-700">
                ...
                <p className="text-gray-700">
                  Електрик працює безпосередньо на об'єкті у Дніпрі, без посередників і затримок.
                </p>
            </div>
          </div>
        </div>
